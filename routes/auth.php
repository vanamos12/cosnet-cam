...
//Route::group(function () {
    Route::get('sign-up-step1', [RegisteredUserController::class, 'signUpStep1Create'])
                ->name('sign-up-step1');

    
    Route::post('sign-up-step1', [RegisteredUserController::class, 'signUpStep1Store']);

    Route::get('sign-up-step2', [RegisteredUserController::class, 'signUpStep2Create'])
                ->name('sign-up-step2');

    Route::post('sign-up-step2', [RegisteredUserController::class, 'signUpStep2Store']);
