        ...
        @unless(!count($members))
            ...
            <div class="max-w-full overflow-x-auto">
                ...
                <thead>
                    ...
                    <th
                        class="min-w-[150px] px-4 py-4 font-medium text-black dark:text-white xl:pl-11"
                    >
                        First Name
                    </th>
                    <th
                ...
                <tbody>
                    ...
                    >
                        <h5 class="font-medium text-black dark:text-white">{{ $member->first_name}}</h5>
                    </td>
                    <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <h5 class="font-medium text-black dark:text-white">{{ $member->last_name}}</h5>
                    </td>
                    <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
