...
>
  ...
  <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
    <a href="index.html">
      <img src="{{ Vite::asset('resources/images/tailadmin/logo/logo.svg')}}" alt="Logo" />
    </a>
    ...
    >
      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <!-- Menu Item Add Member -->
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="{{ route('member.create') }}"
              :class="{ 'bg-graydark dark:bg-meta-4': {{request()->routeIs('member.create')}} }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': {{request()->routeIs('member.index')}} }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': {{ request()->routeIs('profile.edit') }} }"
            >
              <svg
                class="fill-current"
                width="18"
