  ...
  >
    <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
      ...
      <a class="block flex-shrink-0 lg:hidden" href="index.html">
        <img src="{{ Vite::asset('resources/images/tailadmin/logo/logo-icon.svg')}}" alt="Logo" />
      </a>
    </div>
          ...
          >
            ...
            <ul class="flex h-auto flex-col overflow-y-auto">
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ Vite::asset('resources/images/tailadmin/user/user-02.png')}}" alt="User" />
                  </div>
              ...
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ Vite::asset('resources/images/tailadmin/user/user-03.png')}}" alt="User" />
                  </div>
              ...
              <li>
                ...
                >
                  <div class="h-12.5 w-12.5 rounded-full">
                    <img src="{{ Vite::asset('resources/images/tailadmin/user/user-04.png')}}" alt="User" />
                  </div>
